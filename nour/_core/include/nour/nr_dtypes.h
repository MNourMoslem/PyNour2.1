...
#define NDtype_IsInteger(dtype) (NDtype_GetDtypeType(dtype) == NDTYPE_INT)
#define NDtype_IsFloat(dtype) (NDtype_GetDtypeType(dtype) == NDTYPE_FLOAT)
#define NDtype_IsBool(dtype) (NDtype_GetDtypeType(dtype) == NDTYPE_BOOL)
