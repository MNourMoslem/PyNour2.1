...
// Bigger Equal Than
NMATH_2I_FUNCTION_TEMPLATE(Bge, NMATH_BGE, nr_bool, nr_bool)
NMATH_2I_FUNCTION_TEMPLATE(Bge, NMATH_BGE, nr_bool, nr_int8)
NMATH_2I_FUNCTION_TEMPLATE(Bge, NMATH_BGE, nr_bool, nr_uint8)
NMATH_2I_FUNCTION_TEMPLATE(Bge, NMATH_BGE, nr_bool, nr_int16)
NMATH_2I_FUNCTION_TEMPLATE(Bge, NMATH_BGE, nr_bool, nr_uint16)
NMATH_2I_FUNCTION_TEMPLATE(Bge, NMATH_BGE, nr_bool, nr_int32)
NMATH_2I_FUNCTION_TEMPLATE(Bge, NMATH_BGE, nr_bool, nr_uint32)
NMATH_2I_FUNCTION_TEMPLATE(Bge, NMATH_BGE, nr_bool, nr_int64)
NMATH_2I_FUNCTION_TEMPLATE(Bge, NMATH_BGE, nr_bool, nr_uint64)
NMATH_2I_FUNCTION_TEMPLATE(Bge, NMATH_BGE, nr_bool, nr_float32)
NMATH_2I_FUNCTION_TEMPLATE(Bge, NMATH_BGE, nr_bool, nr_float64)

NMATH_METHOD_ARRAY(Bge, NMATH_METHODS_ALL(Bge))

NMATH_2I_MAIN_FUNCTION(Bge, "greater than or equal operation", NONE, BOOL, 1)
