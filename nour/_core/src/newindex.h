#ifndef NR__CORE__SRC__NEWINDEX_H
#define NR__CORE__SRC__NEWINDEX_H
...
#define NIndexRuleSet_BASE_ARRAY(rsp)   ((rsp)->base_array)
...
#endif // NR__CORE__SRC__NEWINDEX_H